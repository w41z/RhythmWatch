...
{
    lv_obj_add_event_cb(ui->home_RTC, home_RTC_event_handler, LV_EVENT_CLICKED, ui);
    lv_obj_add_event_cb(ui->home_DHT11, home_DHT11_event_handler, LV_EVENT_CLICKED, ui);
    lv_obj_add_event_cb(ui->home_MUSIC, home_MUSIC_event_handler, LV_EVENT_CLICKED, ui);
    lv_obj_add_event_cb(ui->home_WEATHER, home_WEATHER_event_handler, LV_EVENT_CLICKED, ui);
}
...
{
    lv_obj_add_event_cb(ui->rtc_screen_btn_1, rtc_screen_btn_1_event_handler, LV_EVENT_CLICKED, ui);
}
...
{
    lv_obj_add_event_cb(ui->dht11_screen_btn_1, dht11_screen_btn_1_event_handler, LV_EVENT_CLICKED, ui);
}
...
{
    lv_obj_add_event_cb(ui->music_screen_btn_1, music_screen_btn_1_event_handler, LV_EVENT_CLICKED, ui);
}
...
{
    lv_obj_add_event_cb(ui->weather_screen_btn_1, weather_screen_btn_1_event_handler, LV_EVENT_CLICKED, ui);
    lv_obj_add_event_cb(ui->weather_screen_fetch, weather_screen_fetch_event_handler, LV_EVENT_CLICKED, ui);
}
